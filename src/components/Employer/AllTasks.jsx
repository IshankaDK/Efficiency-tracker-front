...
const tasks = [
    ...
    },
    {
      ...
      taskDescription: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
...
const AllTasks = () => {
  return (
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 m-6">
    {tasks.map((task) => (
      <div key={task.id} className="p-4 bg-gray-200 rounded-lg shadow-lg">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center">
            <img src={task.employeeImage} alt={task.employeeName} className="w-16 h-216 rounded-full mr-2" />
        ...
        {/* add more details about the task here as needed */}
      </div>
    ))}
  </div>
  )
